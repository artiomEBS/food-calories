    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protein', models.DecimalField(decimal_places=4, default=0.0, max_digits=19, validators=[django.core.validators.MinValueValidator(limit_value=0)], verbose_name='Protein (gr)')),
                ('carbohydrate', models.DecimalField(decimal_places=4, default=0.0, max_digits=19, validators=[django.core.validators.MinValueValidator(limit_value=0)], verbose_name='Carbohydrate (gr)')),
                ('fat', models.DecimalField(decimal_places=4, default=0.0, max_digits=19, validators=[django.core.validators.MinValueValidator(limit_value=0)], verbose_name='Fat (gr)')),
                ('fiber', models.DecimalField(decimal_places=4, default=0.0, max_digits=19, validators=[django.core.validators.MinValueValidator(limit_value=0)], verbose_name='Fiber (gr)')),
                ('sugar', models.DecimalField(decimal_places=4, default=0.0, max_digits=19, validators=[django.core.validators.MinValueValidator(limit_value=0)], verbose_name='Sugar (gr)')),
                ('salt', models.DecimalField(decimal_places=4, default=0.0, max_digits=19, validators=[django.core.validators.MinValueValidator(limit_value=0)], verbose_name='Salt (gr)')),
            ],
            options={
                'verbose_name': 'Food',
        ...
        migrations.AddField(
            model_name='food',
            name='category',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Category', to='journal.foodcategory'),
        ),
        migrations.AddField(
            model_name='food',
            name='portions',
            field=models.ManyToManyField(blank=True, related_name='Portions', to='journal.FoodPortion'),
        ),
        migrations.AddField(
            model_name='food',
            name='user',
